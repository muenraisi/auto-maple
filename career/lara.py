...
SKILLS = {
    "q": {"down_time": 0.6, "up_time": 0.4, "cooldown": True, "manna": 0.1},  # 公主庇佑:900
    "w": {"down_time": 0.6, "up_time": 0.4, "cooldown": True, "manna": 0.1},  # 晓之阵集结：？
    "e": {"down_time": 0.6, "up_time": 0.4, "cooldown": True, "manna": 0.1},  # 英雄之回声：？
    "r": {"down_time": 0.6, "up_time": 0.6, "cooldown": True, "manna": 0.1},  # 霸王咆哮:?
}
        ...
        while config.enabled and \
            ...
            if toggle:
                ...
                if abs(d_x) > config.move_tolerance / math.sqrt(2):
                    jump = str(abs(d_x) > config.move_tolerance * 1.5)
                    if d_x < 0:
